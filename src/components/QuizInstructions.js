	...
	<>
		...
		<div className="instructions container">
			...
			<ul className="browser-default" id="main-list">
				<li>На игру отводится 15 минут.</li>
				<li>Каждая игра состоит из 15-ти вопросов.</li>
				<li>
					Каждый вопрос включает 4 ответа.
				...
				<li>
					На каждую игру у тебя есть два вида подсказок:
					<ul id="sublist">
				...
				<li>
					При выборе подсказки 50-50
					<span className="mdi mdi-set-center mdi-24px lifeline-icon"></span>
					будут убраны 2 неверных ответа
